...
The orchestrator gives you one path in the dispatch prompt: the absolute path to the subtask file (e.g. `/abs/path/.hyper/tasks/T27-.../T27.3.md`). Everything else is derived from the parent folder.
